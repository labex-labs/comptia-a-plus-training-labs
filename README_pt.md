# Laboratórios de Treinamento para Certificação CompTIA A+
...
<p align="center">
  <a href="https://labex.io/pt/courses/comptia-a-plus-training-labs">
    <img src="https://course-cover.labex.io/comptia-a-plus-training-labs.png?lang=pt" alt="Laboratórios de Treinamento para Certificação CompTIA A+">
  </a>
</p>
...
[Iniciar curso no LabEx](https://labex.io/pt/courses/comptia-a-plus-training-labs)

## Exercícios

|   Índice | Nome                                            | Dificuldade   | Prática                                                                                                                                                     |
|----------|-------------------------------------------------|---------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       01 | Instalando Módulos de RAM Virtual               | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-installing-virtual-ram-modules-632799?course=comptia-a-plus-training-labs'>Iniciar Lab</a>          |
|       02 | Configurando Dispositivos de Armazenamento      | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-configuring-storage-devices-632793?course=comptia-a-plus-training-labs'>Iniciar Lab</a>             |
